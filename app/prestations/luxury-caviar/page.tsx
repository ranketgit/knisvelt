      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <h2 className="text-xl text-gray-500 font-medium leading-relaxed max-w-3xl">
            Un soin d’exception pour revitaliser intensément la peau et révéler un teint éclatant
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-start">
          ...
          <div className="flex flex-col gap-10">
            <div className="relative w-full h-[350px] rounded-[2rem] overflow-hidden bg-gray-100 shadow-sm">
               <Image 
                 src="/new-services/6.jpeg" 
                 alt="Soin Luxury Caviar" 
                 fill 
            ...
            <div className="text-gray-500 text-[17px] leading-relaxed space-y-8">
              <section>
                ...
                <p>
                  Le Soin Luxury Caviar est un traitement visage haut de gamme enrichi en extrait de caviar reconnu pour ses propriétés régénérantes et revitalisantes.
                  Ce protocole luxueux nourrit la peau en profondeur, stimule le renouvellement cellulaire et aide à améliorer l’élasticité cutanée pour une peau visiblement plus ferme et lumineuse.
                </p>
              </section>
              ...
              <div className="bg-[#FAF8F7] p-8 lg:p-10 rounded-[2rem] border border-gray-50">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Nutrition intense de la peau</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#E38F75] mt-1">•</span>
                    <span>Stimulation du renouvellement cellulaire</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#E38F75] mt-1">•</span>
                    <span>Amélioration de l’élasticité et de la fermeté</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[#E38F75] mt-1">•</span>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[#E38F75] mt-1">•</span>
                    <span>Teint plus lumineux et peau revitalisée</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p>La peau retrouve éclat souplesse et vitalité avec un effet peau repulpée et lumineuse.</p>
                </div>
              </div>
              ...
              <div className="bg-[#2A2A2A] p-8 rounded-[2rem] text-white">
                ...
                <p className="opacity-90 leading-relaxed italic">
                  Chez KINESVELT by Imane D, ce soin est réalisé selon un protocole expert afin d’offrir à la peau une expérience luxueuse et des résultats visibles dès la première séance.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Sticky Side Card */}
          <BookingForm serviceName="Soin Luxury Caviar" />
