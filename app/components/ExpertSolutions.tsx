      ...
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="flex flex-col">
          ...
          <h2 className="text-3xl lg:text-[2.5rem] font-medium leading-[1.2] text-[#2A2A2A] mb-6">
            Programmes d'amincissement sur mesure à Casablanca
          </h2>
          ...
          <p className="text-gray-500 text-[15px] leading-relaxed mb-8">
            Nos kinésithérapeutes combinent plusieurs technologies selon vos besoins : lipocavitation, LPG, EMS Neo, radiofréquence, ondes de choc. Chaque séance est réalisée en box individuel fermé, dans un environnement cliniquement contrôlé.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 mb-10 items-start sm:items-center">
            ...
            <ul className="space-y-3 flex-1">
              <li className="flex items-center gap-3">
                ...
                <span className="text-[#2A2A2A] text-sm font-medium">Un bilan morphologique offert avant chaque programme</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-gray-800 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="bg-[#EEF3ED] rounded-xl p-4 flex items-center gap-3 w-full sm:w-auto max-w-[220px]">
              ...
              <span className="text-sm font-medium text-[#2A2A2A] leading-tight">Technologies certifiées FDA</span>
            </div>
          </div>

          <div>
            <Link href='/prestations/corps' className="bg-[#E38F75] hover:bg-[#d47b60] transition-colors text-white px-8 py-3.5 rounded-full font-medium text-sm inline-flex items-center gap-2">
