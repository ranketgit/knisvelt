      ...
      <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 items-stretch">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 lg:p-14 shadow-sm flex flex-col justify-center">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-10">
            <button className="bg-[#E38F75] hover:bg-[#d47b60] transition-colors text-white px-8 py-3.5 rounded-full font-medium text-sm">
              Prendre un Rendez-vous
            </button>
            <button className="bg-white hover:bg-gray-50 transition-colors border border-gray-200 text-[#2A2A2A] px-8 py-3.5 rounded-full font-medium text-sm flex items-center gap-2">
              Regarder Video
