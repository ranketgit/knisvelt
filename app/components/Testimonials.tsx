    ...
    <section className="bg-[#FAF8F7] py-16 lg:py-24 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-6">
          <div>
            <h2 className="text-3xl lg:text-[2.5rem] font-medium leading-[1.2] text-[#2A2A2A] mb-3">
              Ce que disent nos patients — avis Google vérifiés
            </h2>
            {/* Nouvelle ligne ajoutée ici avec une étoile */}
            <div className="flex items-center gap-2 text-gray-500 text-[15px] font-medium">
              ...
              <span>4.9/5 sur Google — Plus de 200 avis vérifiés</span>
            </div>
          </div>
