      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-start">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl lg:text-5xl font-medium leading-tight text-[#2A2A2A] mb-6 uppercase tracking-tight">ONDES DE CHOC X-WAVE EXPERT</h1>
            <h2 className="text-xl lg:text-2xl text-gray-400 font-medium mb-10 leading-relaxed">Technologie de stimulation mécanique profonde et restructuration tissulaire</h2>

            {/* FIXED HEIGHT IMAGE CONTAINER */}
            <div className="relative w-full h-[250px] lg:h-[350px] mb-12 rounded-[2rem] overflow-hidden bg-gray-100 shadow-sm">
              <Image 
                src="/ondes.jpeg" 
                alt="Ondes de Choc X-Wave Expert" 
                fill 
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div>
                <h3 className="text-lg font-medium text-[#2A2A2A] mb-4 uppercase text-sm tracking-widest">Action spécifique</h3>
                <ul className="space-y-2 text-gray-500 text-[15px]">
                  <li>• Fragmentation des amas fibreux</li>
                  <li>• Stimulation microcirculation</li>
                  <li>• Activation du drainage</li>
                  <li>• Oxygénation des tissus</li>
                </ul>
              </div>
              <div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-500 text-[15px]">
                  ...
                  <li>• Réduction aspect capitonné</li>
                  <li>• Peau plus souple</li>
                  <li>• Contour sculpté</li>
                </ul>
              </div>
            </div>
