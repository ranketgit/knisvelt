      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-start">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl lg:text-5xl font-medium leading-tight text-[#2A2A2A] mb-6">EMTONE – BTL</h1>
            ...
            <h2 className="text-xl lg:text-2xl text-[#2A2A2A] font-medium mb-10 leading-relaxed">Technologie exclusive combinant radiofréquence et ondes de pression – Traitement avancé de la cellulite</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div>
                ...
                <p className="mt-4 text-[14px] text-gray-500 italic">Particulièrement efficace sur la cellulite même ancienne et résistante.</p>
              </div>
              <div>
                <h3 className="text-lg font-medium text-[#2A2A2A] mb-4">Résultats</h3>
                <ul className="space-y-2 text-gray-500 text-[15px]">
                  <li>Réduction visible de la cellulite</li>
                  <li>Amélioration significative de la fermeté de la peau</li>
                  <li>Amélioration de la qualité et de la texture cutanée</li>
                  <li>Raffermissement des tissus</li>
                  <li>Silhouette plus lisse et plus harmonieuse</li>
                </ul>
