      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-start">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl lg:text-5xl font-medium leading-tight text-[#2A2A2A] mb-6">T-CARE SLIM</h1>
            ...
            <h2 className="text-xl lg:text-2xl text-[#2A2A2A] font-medium mb-10 leading-relaxed">Technologie TECAR – Stimulation cellulaire profonde par radiofréquence capacitive et résistive</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-500 text-[15px]">
                  ...
                  <li>Amélioration de la qualité et de l’élasticité cutanée</li>
                  <li>Stimulation naturelle du collagène</li>
                  <li>Amélioration du drainage et de la circulation</li>
                  <li>Réduction de la cellulite et amélioration globale de la silhouette</li>
                </ul>
            ...
            <div className="bg-[#FAF8F7] rounded-[2rem] p-8 lg:p-10 border border-gray-50 text-center">
              <p className="text-[#2A2A2A] text-lg font-medium italic">
