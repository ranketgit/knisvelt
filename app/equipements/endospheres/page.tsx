      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-start">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl lg:text-5xl font-medium leading-tight text-[#2A2A2A] mb-6">ENDOSPHÈRES</h1>
            <h2 className="text-xl lg:text-2xl text-gray-500 font-medium mb-10 leading-relaxed">Technologie de micro-vibration compressive – Drainage et remodelage avancé</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div>
                ...
                <p className="mt-4 text-[14px] text-gray-500 italic">Particulièrement efficace pour les problèmes de cellulite et de rétention d’eau.</p>
              </div>
              <div>
                <h3 className="text-lg font-medium text-[#2A2A2A] mb-4">Résultats</h3>
                <ul className="space-y-2 text-gray-500 text-[15px]">
                  <li>Réduction visible de la cellulite</li>
                  <li>Amélioration du drainage lymphatique et diminution de la rétention d’eau</li>
                  <li>Raffermissement des tissus</li>
                  <li>Amélioration de la qualité et de la fermeté de la peau</li>
                  <li>Silhouette plus légère et plus harmonieuse</li>
                </ul>
                <p className="mt-4 text-[14px] text-gray-500 italic">Les résultats sont visibles progressivement dès les premières séances.</p>
              </div>
            </div>
