      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-start">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl lg:text-5xl font-medium leading-tight text-[#2A2A2A] mb-6 tracking-tight uppercase">EXILIS – BTL</h1>
            ...
            <h2 className="text-xl lg:text-2xl text-[#2A2A2A] font-medium mb-10 leading-relaxed">
              Technologie avancée combinant radiofréquence et ultrasons – Remodelage et raffermissement
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div>
                ...
                <p className="mt-4 text-[14px] text-gray-400 italic">Particulièrement efficace pour traiter le relâchement cutané.</p>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-gray-500 text-[15px]">
                  ...
                  <li>• Silhouette plus harmonieuse</li>
                </ul>
                <p className="mt-4 text-[14px] text-gray-400 italic">Résultats visibles dès les premières séances avec amélioration progressive.</p>
              </div>
            </div>
