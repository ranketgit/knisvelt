      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-start">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl lg:text-5xl font-medium leading-tight text-[#2A2A2A] mb-6">I-LIPO</h1>
            <h2 className="text-xl lg:text-2xl text-gray-500 font-medium mb-10 leading-relaxed">Technologie laser lipolytique de dernière génération</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-500 text-[15px]">
                  <li>Réduction des centimètres dès les premières séances</li>
                  <li>Diminution de la graisse localisée</li>
                  <li>Affinement visible de la silhouette</li>
                  <li>Amélioration de la qualité et fermeté de la peau</li>
                </ul>
              </div>
            </div>
            ...
            <div className="mb-12">
              <h3 className="text-2xl font-medium text-[#2A2A2A] mb-6">Pourquoi une séance de 30 minutes ?</h3>
